...
/**
  * 
   ...
   #LIQ+#RFI+#SHIB+#SAFEMOON+#USD = #SCAM
   #SCAMCOIN features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee auto distribute to all holders
   I created a black hole so #SCAM token will deflate itself in supply with every transaction
   30% Supply is burned at start to Binance Team.
...
contract SCAMCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2167000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Scam Coin";
    ...
    uint256 public _maxTxAmount = 2167000000000 * 10**9;
